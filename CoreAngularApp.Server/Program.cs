...
using CoreAngularApp.Core.Models.Account;
using CoreAngularApp.Core.Services;
using CoreAngularApp.Core.Services.Account;
using CoreAngularApp.Core.Services.Shop;
using CoreAngularApp.Server.Authorization;
using CoreAngularApp.Server.Authorization.Requirements;
using CoreAngularApp.Server.Configuration;
using CoreAngularApp.Server.Services;
using CoreAngularApp.Server.Services.Email;
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.DocumentTitle = "Swagger UI - CoreAngularApp";
